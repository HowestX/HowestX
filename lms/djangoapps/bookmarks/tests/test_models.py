...
class BookmarkModelTest(ModuleStoreTestCase):
    ...
    def test_create_bookmark_success(self):
        ...
        bookmark_object = Bookmark.create(bookmark_data=bookmark_data)
    ...
    def test_create_raises_exception_for_unreachable_block(self):
        ...
        """
        bookmark_data = self.get_bookmark_data(self.vertical)
        bookmark_data['usage_key'] = UsageKey.from_string('i4x://arbi/100/html/340ef1771a0940')
        with self.assertRaises(ItemNotFoundError):
            Bookmark.create(bookmark_data=bookmark_data)
